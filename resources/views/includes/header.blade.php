...
<!--[if lte IE 8]>
{{HTML::style('assets/js/html5shiv.min.js')}}
				...
				<div class="navbar-header pull-left">
					<a href="index.html" class="navbar-brand">
						<small>
							...
							ColorElephent Candidate Evaluation
						</small>
					</a>
				</div>
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="{{URL::to('/')}}/assets/images/avatars/user.jpg" alt="Jason's Photo" />
